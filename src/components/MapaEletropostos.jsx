...
//                 >
//                   <strong>{posto.nome}</strong>
//                   <span>{posto.potencia} - {calculo.distanciaKm.toFixed(1).replace('.', ',')} km - {formatarMinutos(calculo.tempoTotal)}</span>
//                 </button>
//               ))}
//             </div>
...
//                     <h4>Conectores</h4>
//                     <p>{conectorAtual.conectores} conectores · {conectorAtual.carregadores} carregador(es)</p>
//                     <p>Rede: <strong>{conectorAtual.rede}</strong></p>
//                     <p>Tipo: <strong>{conectorAtual.tipo}</strong></p>
//                   </section>
...
//                       {informacoesPosto.map((item) => (
//                         <div className="bb-info-row" key={item.titulo}>
//                           <strong>{item.titulo}:</strong> {item.chips ? item.chips.join(', ') : item.conteudo}
//                         </div>
//                       ))}
//                     </div>
//                   </section>
